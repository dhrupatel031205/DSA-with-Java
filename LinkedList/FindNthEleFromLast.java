...
/*
    ...
    Extra Method :-			
    	6. findNthLastLength() --> find the nth last element
*/
import java.util.*;
...
class LinkedList {
	...
	// find nth last node's data of the list
	void findNthEleFromLast(int n) {
		Node temp = Head;
		Node dummy = Head;
		int count = 0;
		while (count < n) {
		...
		System.out.println("value at nth index from the last " + dummy.data);
	}
...
class Main {
    public static void main(String args[]) {
        ...
        while (b) {
            ...
            System.out.println("Enter 6 for find the last nth element");
