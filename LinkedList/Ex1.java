/*
    ...
    Extra Method :-			
		6. sortTheList() --> remove the duplicate elements 
*/
import java.util.*;
...
class LinkedList {
    ...
    // mehtod for remove the duplicate elements
    void sortTheList() {
        Node temp = Head;
...
class Main {
    public static void main(String args[]) {
        ...
        while (b) {
            ...
            System.out.println("Enter 6 for sort the list and remove the duplicate data");
